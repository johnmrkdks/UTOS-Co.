...
export type IsCarFuelTypeExistParams = z.infer<
	typeof IsCarFuelTypeExistServiceSchema
>;

export async function isCarFuelTypeExistService(
	db: DB,
	{ name }: IsCarFuelTypeExistParams,
) {
