...
export type DeletePricingConfigParams = z.infer<
	typeof DeletePricingConfigServiceSchema
>;

export async function deletePricingConfigService(
	db: DB,
	{ id }: DeletePricingConfigParams,
) {
