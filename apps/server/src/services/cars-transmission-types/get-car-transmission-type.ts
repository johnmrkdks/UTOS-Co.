...
export type GetCarTransmissionTypeByIdParams = z.infer<
	typeof GetCarTransmissionTypeServiceSchema
>;

export async function getCarTransmissionTypeService(
	db: DB,
	{ id }: GetCarTransmissionTypeByIdParams,
) {
