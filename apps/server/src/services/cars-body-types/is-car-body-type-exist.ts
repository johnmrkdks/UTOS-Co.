...
export type IsCarBodyTypeExistParams = z.infer<
	typeof IsCarBodyTypeExistServiceSchema
>;

export async function isCarBodyTypeExistService(
	db: DB,
	{ name }: IsCarBodyTypeExistParams,
) {
