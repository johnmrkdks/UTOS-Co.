...
export type DeleteCarConditionTypeParams = z.infer<
	typeof DeleteCarConditionTypeServiceSchema
>;
...
export async function deleteCarConditionTypeService(
	...
	if (carCount > 0) {
		throw ErrorFactory.badRequest(
			"Some entities are using this car condition type. Please delete them first.",
		);
	}
