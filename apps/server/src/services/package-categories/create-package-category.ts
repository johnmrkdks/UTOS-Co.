...
export type CreatePackageCategoryParams = z.infer<typeof CreatePackageCategoryServiceSchema>;

export async function createPackageCategoryService(db: DB, data: CreatePackageCategoryParams) {
