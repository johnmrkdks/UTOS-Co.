-- Make user_id nullable for guest bookings (required for createCustomBookingFromQuoteAsGuest)
-- Run in Cloudflare D1 Console (downunderchauffeurs-db). BACKUP first.
-- Run the ENTIRE block as one execution.
...
CREATE TABLE bookings_new (
  ...
  driver_assignment_email_sent_at INTEGER,
  driver_assignment_email_sent_to_driver_id TEXT,
  completion_summary_email_sent_at INTEGER,
