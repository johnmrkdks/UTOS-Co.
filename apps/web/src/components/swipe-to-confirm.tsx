...
export function SwipeToConfirm({
	...
	const [actionState, setActionState] = useState<"idle" | "confirming" | "cancelling" | "processing">("idle")
	...
	}, [isDragging, disabled, dragPosition, threshold, cancelThreshold, resetSlider, isProcessing, minProcessingTime])
			...
			>
				...
				<div
					...
					className={cn(
						...
						disabled || isProcessing ? "cursor-not-allowed opacity-50" : "cursor-grab active:cursor-grabbing",
						getSliderColor(),
