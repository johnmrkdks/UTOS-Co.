...
export function CarAppointmentBookingDialog({
	...
	const handleSubmit = async (data: CarAppointmentForm) => {
		...
		try {
			...
			const baseFare = 50.0; // $50.00 base fare
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
				<DialogHeader className="space-y-1">
					...
					<DialogDescription>
						{currentStep === "details" &&
							`Schedule a chauffeur service with ${car.model?.brand?.name} ${car.model?.name}`}
						...
						<div className="flex items-center gap-4">
							...
							<div className="flex-1">
								...
								<p className="text-muted-foreground text-sm">
									{car.model?.year} • {car.category?.name} •{" "}
											...
											render={({ field }) => (
												<FormItem>
													...
													<p className="text-muted-foreground text-xs">
														Maximum {car.seatingCapacity} passengers for this
														vehicle
													</p>
												</FormItem>
											)}
					...
					<div className="space-y-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Please review all details before confirming your chauffeur
									service
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-4">
								...
								<div className="space-y-3">
									...
									<div className="grid grid-cols-1 gap-3 text-sm md:grid-cols-2">
										...
										<div>
											...
											<div className="font-medium">
												{form.getValues("estimatedDuration")} minutes
											</div>
										</div>
									</div>
								...
								<div className="space-y-2 rounded-lg bg-muted/50 p-3">
									...
									<ul className="space-y-1 text-muted-foreground text-xs">
										<li>
											• This is a custom appointment booking with your selected
											vehicle
										</li>
										<li>
