...
import { Calendar, LogOutIcon, Settings, User } from "lucide-react";
				...
				<DropdownMenuContent className="max-w-64" align="end">
					...
					<DropdownMenuGroup>
						<DropdownMenuItem asChild>
							<Link to="/my-bookings" className="flex w-full items-center">
								<Calendar
									size={16}
					...
					<DropdownMenuGroup>
						...
						<DropdownMenuItem asChild>
							<Link to="/account/settings" className="flex w-full items-center">
								<Settings
									size={16}
									className="mr-2 opacity-60"
									aria-hidden="true"
