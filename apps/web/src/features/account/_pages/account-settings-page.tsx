...
export function AccountSettingsPage() {
	...
	// TODO: Add accounts information to user session or fetch separately
	const isGoogleConnected = false; // Placeholder until accounts data is available
				...
				<div className="space-y-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Manage your password and connected accounts for secure access
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							...
							<div className="space-y-4">
								<div>
									...
									<p className="text-sm text-gray-500">Link your account with social providers for easier sign-in</p>
								</div>
