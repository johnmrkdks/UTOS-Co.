...
export const DetailedSpecifications = memo<DetailedSpecificationsProps>(
	({ car }) => {
		return (
			<div>
				...
				<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
					<SpecSection title="Basic Info">
						<SpecItem
							...
							value={`${car.seatingCapacity} passengers`}
						/>
					...
					<SpecSection title="Drivetrain">
						<SpecItem
							icon={Settings}
							label="Transmission"
							value={car.transmissionType?.name || "N/A"}
						/>
						<SpecItem
							icon={Navigation}
							label="Drive Type"
							value={car.driveType?.name || "N/A"}
						/>
					</SpecSection>
