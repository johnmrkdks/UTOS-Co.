...
export function DraftDialog({ open, onOpenChange, onLoadDraft, onDeleteDraft, draftAge }: DraftDialogProps) {
	return (
			...
			<AlertDialogContent>
				...
				<AlertDialogFooter className="flex-col sm:flex-row gap-2">
					<div className="flex gap-2">
						...
						<AlertDialogCancel onClick={() => onOpenChange(false)}>Start Fresh</AlertDialogCancel>
					</div>
...
export function DiscardDialog({ open, onOpenChange, onConfirmDiscard, isSubmitting }: DiscardDialogProps) {
	return (
		<AlertDialog open={open} onOpenChange={onOpenChange}>
			<AlertDialogContent>
				<AlertDialogHeader>
