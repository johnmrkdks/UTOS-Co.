...
import { ConditionTypeTableRowActions } from "./condition-type-table-row-actions";

export const conditionTypeTableColumns: ColumnDef<CarConditionTypeWithEnrichedData>[] =
	[
		{
			id: "name",
			accessorKey: "name",
		...
		},
		{
			...
			cell: ({ row }) => (
				<div className="mr-4 flex justify-end">
					<ConditionTypeTableRowActions row={row} />
				</div>
			),
			enableSorting: false,
			enableHiding: false,
