...
import type { CarBodyTypeWithEnrichedData } from "server/types"
import { BodyTypeTableRowActions } from "./body-type-table-row-actions"

export const bodyTypeTableColumns: ColumnDef<CarBodyTypeWithEnrichedData>[] = [
	{
		id: "name",
		accessorKey: "name",
		header: ({ column }) => (
			<DataTableColumnHeader className="ml-4" column={column} title="Body Type" />
		),
	...
	},
	{
		...
		cell: ({ row }) => (
			<div className="flex justify-end mr-4">
				<BodyTypeTableRowActions row={row} />
			</div>
		),
		enableSorting: false,
		enableHiding: false,
