 ...
 */
export function generatePricingConfigName(
	carName: string,
	carBrand?: string,
	carModel?: string,
): string {
	...
	if (
		cleanCarName.toLowerCase().includes("pricing") ||
	...
	if (carBrand && carModel) {
		...
		if (
			!cleanCarName.toLowerCase().includes(carBrand.toLowerCase()) ||
 ...
 */
export function generateNamingSuggestions(
	carName: string,
	carBrand?: string,
	carModel?: string,
): string[] {
