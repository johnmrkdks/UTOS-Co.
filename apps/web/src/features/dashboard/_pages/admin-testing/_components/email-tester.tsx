...
export function EmailTester({ onResult }: EmailTesterProps) {
	...
	const sendDriverAssignmentMutation =
		useSendDriverAssignmentNotificationMutation();
		...
		<div className="space-y-6">
			<div>
				...
				<p className="mt-1 text-gray-600 text-sm">
					Test OAuth 2.0 email functionality including all email templates and
					notifications
				</p>
			</div>
			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div className="grid gap-4 md:grid-cols-2">
						...
						<div className="space-y-2">
							<Label htmlFor="test-booking-id">
								Booking ID (for notifications)
							</Label>
							<Input
								id="test-booking-id"
								type="text"
					...
					<div className="space-y-2">
						<Label htmlFor="test-driver-id">
							Driver ID (for assignment notifications)
						</Label>
						<Input
							id="test-driver-id"
							type="text"
				...
				<CardContent>
					<div className="space-y-4">
						<p className="text-gray-600 text-sm">
							Test the OAuth 2.0 connection with Gmail and verify email
							delivery.
						</p>
						<Button
			...
			<Card>
				...
				<CardContent>
					<div className="space-y-4">
						<p className="text-gray-600 text-sm">
							Test booking-related notifications sent to drivers and clients.
							These require valid booking and driver IDs.
						</p>
						<Separator />
						<div className="grid gap-3 sm:grid-cols-2">
							<Button
						...
						<div className="rounded-lg border border-blue-200 bg-blue-50 p-3">
							<p className="text-blue-700 text-xs">
								<strong>Note:</strong> Driver assignment notifications are sent
								to the driver's email address, while trip status updates are
								sent to the customer's email address associated with the
								booking.
							</p>
						</div>
					</div>
