...
export const useBookingManagementModalProvider =
	create<BookingManagementModalState>((set) => ({
		...
		openCreatePackageBookingDialog: () =>
			set({ isCreatePackageBookingDialogOpen: true }),
		closeCreatePackageBookingDialog: () =>
			set({ isCreatePackageBookingDialogOpen: false }),

		openCreateCustomBookingDialog: () =>
			set({ isCreateCustomBookingDialogOpen: true }),
		closeCreateCustomBookingDialog: () =>
			set({ isCreateCustomBookingDialogOpen: false }),

		openCreateOffloadBookingDialog: () =>
			set({ isCreateOffloadBookingDialogOpen: true }),
		closeCreateOffloadBookingDialog: () =>
			set({ isCreateOffloadBookingDialogOpen: false }),
