...
import { Calendar, Package, Car, Clock, MapPin, Users, Loader2, CheckCircle, AlertTriangle, ArrowRightIcon, Star, Activity } from "lucide-react";
		...
		return (
			<div className="flex justify-center items-center py-12">
				...
				<span className="ml-2 text-gray-600">
					{sessionLoading ? "Setting up session..." : "Loading your dashboard..."}
				</span>
			</div>
		)
	}
